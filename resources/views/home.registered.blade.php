        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="top table">
                                    <div class="row category">
                                        <div class="cell">
                                            <a class="navigation" href="{{ url($lang.'/mindmap') }}"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('home_registered.full_navigation') }}</a>
                                        </div>
                                        <div class="cell"></div>
                                    </div>
                                </div>
                ...
                <div id="categories-units" class="col-md-8 col-sm-12 col-xs-12">
                    <h1 class="title">{{ trans('home_registered.units') }}</h1>
                    <h1 class="category">{{ trans('home_registered.units') }}</h1>
